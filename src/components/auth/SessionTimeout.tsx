        ...
        <div className="ml-3 flex-1">
          ...
          <div className="mt-3 flex space-x-2">
            <button
              ...
              className="bg-yellow-100 px-3 py-1 rounded-md text-sm font-medium text-yellow-800 hover:bg-yellow-200 focus:outline-none focus:ring-2 focus:ring-yellow-500"
            >
              Extend Session
            </button>
            <button
              onClick={() => setShowWarning(false)}
              className="bg-transparent px-3 py-1 rounded-md text-sm font-medium text-yellow-800 hover:bg-yellow-100 focus:outline-none focus:ring-2 focus:ring-yellow-500"
            >
              Dismiss
            </button>
          </div>
